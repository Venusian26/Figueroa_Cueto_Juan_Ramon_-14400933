...
/**
 * Created by jesus on 8/05/18.
 */

public class SimpleStepDetector {
    private static final int ACCEL_RING_SIZE = 20;
    private static final int VEL_RING_SIZE = 30;
    private static final float STEP_THRESHOLD = 8f;
